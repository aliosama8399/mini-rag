...
async def get_setup_utils():
    ...
    # generation client
    generation_client = llm_provider_factory.create(providers=settings.GENERATION_BACKEND)
    generation_client.set_generation_model(model_id = settings.GENERATION_MODEL_ID)

    # embedding client
    embedding_client = llm_provider_factory.create(providers=settings.EMBEDDING_BACKEND)
